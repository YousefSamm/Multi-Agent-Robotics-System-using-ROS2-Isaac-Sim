...
# Now import Isaac Sim modules after SimulationApp is initialized
import time
...
def setup_simulation():
    ...
    stage_path = os.path.join(
        script_dir, "Collected_noham_forklift", 
        "noham_sim_forklift.usd"
    )
    ...
    required_extensions = [
        "omni.graph.core", "omni.graph.action", 
